...
public class AdminActivity extends AppCompatActivity {
    ...
    Dialog loadingDialog; // Loading dialog
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set up adapter
        adapter = new subjectAdapter(AdminActivity.this, list);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            Toast.makeText(AdminActivity.this, "No subjects found.", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        binding.uploadSubject.setOnClickListener(v ->
                startActivity(new Intent(AdminActivity.this, UploadSubjectActivity.class))
        );
    }
